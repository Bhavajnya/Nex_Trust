...
exports.MockAIService = exports.AIServiceBase = void 0;
 ...
 */
class AIServiceBase {
    constructor(db, confidenceThreshold = 0.75) {
        this.db = db;
        this.confidenceThreshold = confidenceThreshold;
    }
}
exports.AIServiceBase = AIServiceBase;
/**
...
class MockAIService extends AIServiceBase {
    ...
    async verifyCompletion(request) {
        ...
        return {
            ...
            analysis: `Mock AI Analysis: Evidence shows ${metCount}/${requirements.length} requirements met. Recommended action: ${allMet ? 'RELEASE funds to worker' : 'INITIATE dispute for manual review'}`,
            timestamp: Date.now(),
        };
    }
    ...
    async extractRequirements(requirements) {
