...
exports.createReconciliationRoutes = createReconciliationRoutes;
const express_1 = require("express");
const reconciliation_1 = require("../services/reconciliation");
function createReconciliationRoutes(db, stripe, redis, reconciliationWorker) {
    const router = (0, express_1.Router)();
    const reconciliationService = new reconciliation_1.ReconciliationService(db, stripe);
    /**
     ...
     */
    router.post('/reconcile-pair', async (req, res) => {
        try {
